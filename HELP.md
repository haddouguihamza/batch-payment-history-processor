...
* [Spring Batch](https://docs.spring.io/spring-boot/3.4.3-SNAPSHOT/how-to/batch.html)
...
* [Spring HATEOAS](https://docs.spring.io/spring-boot/3.4.3-SNAPSHOT/reference/web/spring-hateoas.html)
* [JDBC API](https://docs.spring.io/spring-boot/3.4.3-SNAPSHOT/reference/data/sql.html)
* [Jersey](https://docs.spring.io/spring-boot/3.4.3-SNAPSHOT/reference/web/servlet.html#web.servlet.jersey)
